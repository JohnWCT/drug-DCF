...
DEFAULT_COMMITTED_PATHS = (
    ...
    "tools/round19_train_loop.py",
    "tools/round19_attention_export.py",
    "tools/round19_attention_ensemble.py",
    "tools/round19_attention_consistency.py",
    "tools/round19_context_attention_sensitivity.py",
    "tools/round19_atom_occlusion.py",
    "tools/connected_substructure_masking.py",
    "tools/scaffold_sidechain_ablation.py",
    "tools/bond_occlusion.py",
    "tools/pooled_drug_occlusion.py",
    "tools/maccs_ablation.py",
    "tools/omics_group_ablation.py",
    "tools/context_sensitivity.py",
    "tools/stage19g_routing_audit.py",
    "tools/routing_counterfactual.py",
    "tools/analyze_round19_stage19g.py",
    "tools/round19_stage19g_case_selector.py",
    "tools/round19_stage19g_case_manifest.py",
    "tools/round19_stage19g_experiment_lock.py",
    "tools/round19_stage19g_lock_adapter.py",
    "tools/round19_stage19g_executor.py",
    "tools/round19_stage19g_dispatch.py",
    "tools/run_round19_stage19g.sh",
